        ...
        <div class="row justify-content-center">
          <div class="col-md-8">
            <div class="card card-primary">
              ...
              <!-- form start -->
              <form action="<?= base_url(); ?>/menu/update/<?= $menu['kode_menu']; ?>" method="POST" enctype="multipart/form-data">
                <div class="card-body">
                  <?= csrf_field(); ?>
                  ...
                  <div class="row mb-3">
                    ...
                    <div class="col-sm-3 mb-2">
                      <img src="<?= base_url(); ?>/assets/img/<?= $menu['gambar']; ?>" class="img-thumbnail img-preview">
                    </div>
                    <div class="col-sm-15">
