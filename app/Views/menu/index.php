			...
			<div class="container-fluid">
				<div class="row mb-2">
					<div class="col-sm-6">
						...
						<?php if (is_koki()) : ?>
							<a href="<?= base_url(); ?>/menu/create" class="btn btn-primary mt-3">Tambah Menu</a>
						<?php endif; ?>
					</div><!-- /.col -->
					<div class="col-sm-6">
									...
									<tbody>
										...
										<?php foreach ($menu as $m) : ?>
											<tr class="text-center">
												...
												<td><?= $m['stok']; ?></td>
												<td><img src="<?= base_url(); ?>/assets/img/<?= $m['gambar']; ?>" alt="" class="gambar"></td>
												<td>
													<a href="<?= base_url(); ?>/menu/<?= $m['slug']; ?>" class="btn btn-info">Detail</a>
												</td>
											</tr>
										<?php endforeach; ?>
									</tbody>
